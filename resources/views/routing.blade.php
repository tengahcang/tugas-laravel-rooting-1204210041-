...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="{{ url('/username/Sonny%20readY') }}" class="list-group-item list-group-item-action">
        ...
        <h6 class="mt-4">Route Bootstrap</h6>
        <div class="list-group mt-4">
            <a href="{{url('/halaman_bootstrap')}}" class="list-group-item">
                Bootstrap
            </a>
        </div>
    </div>
