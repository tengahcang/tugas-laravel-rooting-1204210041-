...
<body>
    <nav class="navbar fixed-top navbar-expand-lg  bg-purple" data-bs-theme="dark">
        <div class="container py-2 px-4">
            ...
            <img class="img-fluid" src="{{ Vite::asset('resources/image/logo-white.svg') }}" alt="logo" style="width: 40px;">
            <button type="button" class="navbar-toggler" data-bs-toggle="offcanvas" data-target="#offcanvasNavbar">
            ...
            <div class="offcanvas offcanvas-end bg-purple"  id="offcanvasNavbar" >
                ...
                <div class="offcanvas-body pt-0 px-4 ">
                    <ul class="navbar-nav flex-grow-row flex-wrap">
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">Docs</a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">Examples</a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">Icons</a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active">Themes</a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                        ...
                        <li class="nav-item">
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item" type="button"><small>v5.2.3</i></small></button></li>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ Vite::asset('resources/image/main.svg') }}" alt="main logo">
                </div>
    ...
    <div id="bs-icons">
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/image/bs-icons.png') }}" alt="bootstrap-icons">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="bs-themes">
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/image/bs-themes.png') }}" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="{{ Vite::asset('resources/image/logo-black.svg') }}" alt="" class="img-fluid" style="width: 40px;">
